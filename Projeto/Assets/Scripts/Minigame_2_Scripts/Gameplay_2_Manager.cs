...
public class Gameplay_2_Manager : MonoBehaviour
{
    #region START

    [SerializeField] private bool hasGameFinished;

    public static Gameplay_2_Manager Instance;
    ...
    [SerializeField] private Score_2 _scorePrefab_v;
    [SerializeField] private Score_3 _scorePrefab_h;
    private Score_1 CurrentScore;

    private IEnumerator SpawnScore()
    {
        //Score_1 prevScore = null;
    ...
    {
        GameEventsManager.Instance.timeEvents.OnEndMorningWork += GameEnded;
    }
